		...
		<head>
			...
			<script langage="javascript">
					function downpage(Pcfilename,Serverfile,folder,DownLoadFile){
						...
						window.open("http://law.kwater.or.kr/jsp/bylaw/existing/hwp.jsp?fileUrl="+Serverfile+"&amp;folder="+folder,"download",property);
					}
...
<xsl:template match="law">
	...
	<xsl:apply-templates select="history|bon|buchicklist|byullist|jo"/>	
</xsl:template>
