...
<!-- 내규 전체 제목 -->
	<input type="text" name="Schtxt" onkeypress="goSch2()"/><button onclick="goSch();">검색</button>
		...
		<xsl:for-each select=".">
			...
			<xsl:if test="./@startcha&lt;=$revcha">
				...
				<div id="jo">
					...
					<xsl:apply-templates select="cont/text()|cont/law|cont/bylaw|cont/image|cont/img|cont/a5b5|cont/span" mode="link"/>
...
<xsl:template name="etc">	
	...
	<xsl:for-each select="hang">
		<xsl:apply-templates select="cont/text()|cont/law|cont/bylaw|cont/image|cont/img|cont/a5b5|cont/span|cont/table" mode="link"/><xsl:value-of select="@showtag"/><br/>
		<xsl:for-each select="ho">
			<div id="ho">
				<xsl:apply-templates select="cont/text()|cont/law|cont/bylaw|cont/image|cont/img|cont/a5b5|cont/span|cont/table" mode="link"/><br/>
			</div>
