...
Ext.onReady(function(){
	...
	rowContext = new Ext.menu.Menu({
		...
		items:[
			...
			{id:'docInfoUpdate',cls:'icon_regmod', text: '문서정보수정(담당자,심의회차)',
				handler: function(){
					//부서창고 
					...
					formCreat = function(result,Bookid){
						...
						var booksubcd = result.BOOKSUBCD;
						var	formTitle = Title + '문서정보 수정';

						var rmInsert = new Ext.FormPanel({
					        labelWidth:80,
					        url : CONTEXTPATH+'/bylaw/adm/docInfoUpdate.do',
					        frame:true,
					        width:385,
					        autoHeight:true,
					        defaultType:'textfield',
					        ...
					        items:[
				            	{
						        xtype: 'textfield', fieldLabel:'심의회차', name: 'booksubcd', allowBlank:false, value:booksubcd,width:230
				           		},
			...
			{id:'PromulI',cls:'icon_ca', text: '시행일/공포일 입력',
				handler: function(){
				...
				var rmInsert = new Ext.FormPanel({
			        ...
			        items:[
			        	...
			        	xtype: 'datefield', fieldLabel:'시행일', name: 'startdt', allowBlank:false, format : 'Y-m-d', value:(new Date()).format('Y-m-d'),width:230
			            },
		           		{
	...
	botToolbar = new Ext.Toolbar({
		...
		items:[
			...
			{
				id:'hkk50',
				text:'<strong style="font-weight:bold;color:#003b59;">결재저장문서확인</strong>',
				iconCls:'pnextStep',
