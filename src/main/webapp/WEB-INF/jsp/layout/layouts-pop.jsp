...
<link rel="stylesheet" type="text/css" href="${resourceUrl}/seoul/css/popup.css">
...
<!-- extjs -->
<script src="${pageContext.request.contextPath}/webjars/extjs/3.4.1.1/adapter/ext/ext-base.js"></script>
<script src="${pageContext.request.contextPath}/webjars/extjs/3.4.1.1/ext-all-debug.js"></script>
<script src="${pageContext.request.contextPath}/webjars/extjs/3.4.1.1/src/locale/ext-lang-ko.js"></script>
...
<!-- 		<span id="closePopup" class="close" onclick="modalClose();">&times;</span> -->
...
<script>
	$(document).ready(function(){
		...
		var className = $('input:visible:enabled:first').attr('class');
		console.log("className : "+className);
		//if (className != undefined) {
			if (className == undefined || className.indexOf("datepick hasDatepicker") == -1) {
