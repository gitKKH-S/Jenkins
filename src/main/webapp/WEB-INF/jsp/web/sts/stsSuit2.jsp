...
<script type="text/javascript">
	...
	$(function () {
		...
		var colModel = [
			...
			{title:"유형별",   dataType:"string", dataIndx:"LWS_LWR_TYPE_NM", editable:false},
			{title:"총건수",   dataType:"string", dataIndx:"TOTAL_CNT",       editable:false},
			{title:"건수",     dataType:"string", dataIndx:"CNT",             editable:false},
			{title:"구성비",   dataType:"string", dataIndx:"RT",              editable:false}
		];
		...
		var dataModel = {
			...
			url: "${pageContext.request.contextPath}/web/statistics/getSuit2.do",
				...
				items:[
					...
					},
					{
						...
						listener: function () {
							...
							saveAs(blob, "수행중 소송사건 유형별."+ format );
						}
				}]
			},
			resizable: false,
