...
<script type="text/javascript">
	...
	$(function () {
		...
		var colModel = [
			{title:"연도",      dataType:"string", dataIndx:"START_YEAR",       editable:false},
			{title:"사건유형",  dataType:"string", dataIndx:"LWS_LWR_TYPE_NM",  editable:false},
			{title:"건수",      dataType:"string", dataIndx:"LOS_CNT",          editable:false}
		];
		...
		$("#btnSubmit").click(function() {
			...
			$( "#grid_jsonp" ).pqGrid("option","dataModel.postData", {schType1: $("#schType1").val(), schType2: $("#schType2").val(), txtStartDate:$("#txtStartDate").val(), txtEndDate:$("#txtEndDate").val(), searchGbn:searchGbn} );
	...
	function setOptionList(data){
		$("#schType2").children('option').remove();
		var html="";
	...
	<div class="innerB">
		<table class="infoTable write" style="width:100%;">
			...
			<tr>
				...
				<td>
					<select name="schType1" id="schType1" onchange="chgUpTypeCd(this.value);">
						<option>선택</option>
<%
