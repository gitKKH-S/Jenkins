	...
	<div class="innerB">
		<table class="infoTable write" style="width:100%">
			...
			<tr>
				...
				<td>
					<input type="text" id="txtStartDate" maxlength="12" style="width:80px" readonly />
			        ~
			        <input type="text" id="txtEndDate" maxlength="12" style="width:80px" readonly/>
				</td>
				<th>차트구분</th>
				<td>
					<input type="radio" name="chartgbn" class="chartgbn" value="1" checked="checked" onchange="setChartGbn(this.value);"/><label>  소송건수  </label>
					<input type="radio" name="chartgbn" class="chartgbn" value="2" onchange="setChartGbn(this.value);"/><label>  소송유형별  </label>
				</td>
				<th>차트종류</th>
				<td>
...
<script type="text/javascript">
	...
	function getChecked_value(){
		...
		var ob2 = document.getElementsByName('chartgbn');
		var txt = ['일별','월별','년도별'];
		//var txt = ['년도별','월별','일별'];
		var gbn = ['소송 건수 현황', '소송 유형별 건수 현황'];
		var retVal = "";
	...
	var c2 = [];
	function bindData() {
	    var jsonPath = "${pageContext.request.contextPath}/web/statistics/getSuit"+chartGbn+".do";
