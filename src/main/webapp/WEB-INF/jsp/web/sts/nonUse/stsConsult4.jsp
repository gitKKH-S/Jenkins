...
<script type="text/javascript">
	...
	$(function () {
				...
				items:[
					...
					},
					{
						...
						listener: function () {
							...
							saveAs(blob, "자문연도별 현황(담당자별)."+ format );
						}
				}]
			}
		};
		...
		obj.colModel = [
			...
			{title:"담당자",      dataType:"integer", dataIndx:"CHRGEMPNM", cls:"leftCol", editable:false, width:80},
		...
		obj.dataModel = {
			...
			dataType: "json",
			method: "POST",
			url: "${pageContext.request.contextPath}/web/statistics/getConsult4.do",
		...
		obj.cellClick=function(evt,ui){
			if (ui.rowData) {
				...
				$( "#grid_jsonp1" ).pqGrid("option","dataModel.postData", { year : ui.rowData['GYEAR'],chrgempnm : ui.rowData['CHRGEMPNM'],csttypecd : csttypecd } );
