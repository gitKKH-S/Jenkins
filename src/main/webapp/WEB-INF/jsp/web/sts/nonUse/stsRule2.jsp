...
<script type="text/javascript">
		...
		$(function () {
	        ...
	        obj.colModel = [
	       	            { title: "구분",     dataType: "integer", dataIndx: "YEAR",  cls:"leftCol", editable: false, width: 180 },
	        ...
	        var colModel1= [
  	            { title: "연도", dataType: "string",align:'center', dataIndx: "YEARS" ,editable: false, width: 50 },
  	            ...
  	            { title: "자치법규명", dataType: "string", dataIndx: "TITLE" ,editable: false, width: 180 },
  	          	{ title: "개정횟수", dataType: "string",align:'center', dataIndx: "CNT" ,editable: false, width: 15 },
  	          	{ title: "최근개정시행일", dataType: "string",align:'center', dataIndx: "SDT" ,editable: false, width: 90 },
       			{ title: "자치법규운영부서", dataType: "string", dataIndx: "DEPTNAME" ,editable: false, width: 80 }
  	        ];
  	        var dataModel1 = {
  	            location: "remote",
  	            dataType: "json",
