			...
			obj.toolbar= {
	                items: [{
	                    ...
	                    listener: function () {
	                        ...
	                        saveAs(blob, "부서별 개정건수."+ format );
	                    }
	                }]
	         }
	        obj.colModel = [
	       	            { title: "구분", dataType: "string", dataIndx: "DEPTNAME",  cls:"leftCol", editable: false, width: 180, align:'center'},
   	        ...
   	        obj.dataModel = {
   	            ...
   	            dataType: "json",
   	            method: "POST",
   	            url: "${pageContext.request.contextPath}/web/statistics/getBylaw10.do",
		   	...
		   	obj.cellClick=function(evt,ui){
	   	    	if (ui.rowData) {
		   	      ...
		   	      $( "#grid_jsonp1" ).pqGrid("option","dataModel.postData", { deptname: ui.rowData['DEPTNAME'],revcd:revcd } );
