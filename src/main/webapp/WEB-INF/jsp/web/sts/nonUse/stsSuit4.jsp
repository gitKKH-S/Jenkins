...
<script type="text/javascript">
	...
	$(function () {
				...
				items:[
					...
					},
					{
						...
						listener: function () {
							...
							saveAs(blob, "법무법인별 소송유형 현황."+ format );
						}
				}]
			}
		};
		...
		obj.colModel = [
			{title:"법무법인", dataType:"string",  dataIndx:"LAWFIRMNAME", cls:"leftCol", editable:false, width:180},
		...
		obj.dataModel = {
			...
			url: "${pageContext.request.contextPath}/web/statistics/getSuit4.do",
		...
		var colModel1= [
			...
			{ title:"법무법인", dataType:"string", align:'center', dataIndx: "LAWFIRMNAME",  editable:false, width:50 },
				...
				items: [
					...
					},
					{
						...
						listener: function () {
							...
							saveAs(blob, "소송 연도별 상세 현황(법무법인별)."+ format );
						}
					}
				]
			}
