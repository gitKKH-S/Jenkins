...
<script type="text/javascript">
	$(function () {
		...
		var colModel = [
			{title:"프로필",              dataType:"string", dataIndx:"PHOTO_MNG_PATH_NM",  editable:false},
			{title:"성명(출생연도)",      dataType:"string", dataIndx:"LWYR_NM",            editable:false},
			{title:"학력",                dataType:"string", dataIndx:"ACBG_CN",            editable:false},
			{title:"합격연도",            dataType:"string", dataIndx:"TEST_INFO",          editable:false},
			{title:"주요경력",            dataType:"string", dataIndx:"CRR_MTTR",           editable:false},
			{title:"전문분야",            dataType:"string", dataIndx:"ARSP_NM",            editable:false},
			{title:"위촉일(최초위촉일)",  dataType:"string", dataIndx:"ENTRST_BGNG_YMD",    editable:false}
		];
		...
		var dataModel = {
			...
			dataType: "json",
			method: "POST",
			url: "${pageContext.request.contextPath}/web/statistics/getSystem4.do",
