...
<script type="text/javascript">
	...
	$(function () {
		...
		var colModel = [
			{title:"연도",       dataType:"string", dataIndx:"YEARS",         editable:false},
			{title:"사건명",     dataType:"string", dataIndx:"DLBR_AGND_NM",  editable:false},
			{title:"회의결과",   dataType:"string", dataIndx:"DLBR_DCS_CN",   editable:false},
			{title:"참석대상",   dataType:"string", dataIndx:"TOTAL",         editable:false},
			{title:"참석인원",   dataType:"string", dataIndx:"ACNT",          editable:false},
			{title:"참석률(%)",  dataType:"string", dataIndx:"CCNT",          editable:false}
		];
