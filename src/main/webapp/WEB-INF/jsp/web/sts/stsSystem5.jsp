...
<script type="text/javascript">
	...
	$(function () {
		...
		var colModel = [
			{title:"성명",          dataType:"string", dataIndx:"LWYR_NM",          editable:false},
			{title:"소속",          dataType:"string", dataIndx:"JDAF_CORP_NM",     editable:false},
			{title:"최초위촉일",    dataType:"string", dataIndx:"ENTRST_BGNG_YMD",  editable:false},
			{title:"소송(건)",      dataType:"string", dataIndx:"SUIT_CNT",         editable:false},
			{title:"법률자문(건)",  dataType:"string", dataIndx:"CNST_CNT",         editable:false},
			{title:"협약(건)",      dataType:"string", dataIndx:"CVTN_CNT",         editable:false},
			{title:"비고",          dataType:"string", dataIndx:"RMRK_CN",          editable:false}
		];
		...
		var dataModel = {
			...
			dataType: "json",
			method: "POST",
			url: "${pageContext.request.contextPath}/web/statistics/getSystem5.do",
				...
				items:[
					...
					},
					{
						...
						listener: function () {
							...
							saveAs(blob, "법률고문 소송수행 및 법률자문 현황."+ format );
						}
				}]
			},
			resizable: false,
