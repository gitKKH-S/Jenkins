...
<script type="text/javascript">
	...
	$(function () {
		...
		var colModel = [
			{title:"구분",           dataType:"string", dataIndx:"GBN",           editable:false},
			{title:"청구일자",       dataType:"string", dataIndx:"GIVE_APLY_YMD", editable:false},
			{title:"승인일자",       dataType:"string", dataIndx:"APRV_YMD",      editable:false},
			{title:"거래처명",       dataType:"string", dataIndx:"A_COL",         editable:false},
			{title:"거래처구분",     dataType:"string", dataIndx:"B_COL",         editable:false},
			{title:"사업자등록번호", dataType:"string", dataIndx:"C_COL",         editable:false},
			{title:"생년월일",       dataType:"string", dataIndx:"D_COL",         editable:false},
			{title:"입급유형",       dataType:"string", dataIndx:"E_COL",         editable:false},
			{title:"은행",           dataType:"string", dataIndx:"F_COL",         editable:false},
			{title:"예금주명",       dataType:"string", dataIndx:"G_COL",         editable:false},
			{title:"계좌번호",       dataType:"string", dataIndx:"H_COL",         editable:false},
			{title:"공급가액",       dataType:"string", dataIndx:"I_COL",         editable:false},
			{title:"부가세액",       dataType:"string", dataIndx:"J_COL",         editable:false}
		];
		...
		var dataModel = {
			...
			dataType: "json",
			method: "POST",
			url: "${pageContext.request.contextPath}/web/statistics/getSuit16.do",
				...
				items:[
					...
					},
					{
						...
						listener: function () {
							...
							saveAs(blob, "E-호조 업로드 자료."+ format );
						}
				}]
			},
			resizable: false,
