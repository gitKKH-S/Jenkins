...
<script type="text/javascript">
	...
	$(function () {
		...
		var colModel = [
			...
			{title:"사건개요",    dataType:"string", dataIndx:"INCDNT_OTLN",     editable:false}
		];
		...
		var dataModel = {
			...
			url: "${pageContext.request.contextPath}/web/statistics/getSuit11.do",
