...
<script type="text/javascript">
	...
	$(function () {
		...
		var colModel = [
			...
			{title:"소계",   dataType:"string", dataIndx:"A_CNT",       editable:false},
			{title:"내부",   dataType:"string", dataIndx:"ICNT",        editable:false},
			{title:"외부",   dataType:"string", dataIndx:"OCNT",        editable:false}
		];
		...
		var dataModel = {
			...
			dataType: "json",
			method: "POST",
			url: "${pageContext.request.contextPath}/web/statistics/getConsult1.do",
