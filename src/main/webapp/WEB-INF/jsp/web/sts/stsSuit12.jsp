...
<script type="text/javascript">
	...
	$(function () {
		...
		var colModel = [
			{title:"유형",        dataType:"string", dataIndx:"INCDNT_SE",       editable:false},
			{title:"구분",        dataType:"string", dataIndx:"LWS_UP_TYPE_NM",  editable:false},
			{title:"관리번호",    dataType:"string", dataIndx:"LWS_NO",          editable:false},
			{title:"법원",        dataType:"string", dataIndx:"CT_NM",           editable:false},
			...
			{title:"원고",        dataType:"string", dataIndx:"WONGO",           editable:false},
			{title:"피고",        dataType:"string", dataIndx:"PIGO",            editable:false},
			{title:"접수일",      dataType:"string", dataIndx:"FLGLW_YMD",       editable:false},
			{title:"담당변호사",  dataType:"string", dataIndx:"TKCG_EMP_NM",     editable:false},
			{title:"부서",        dataType:"string", dataIndx:"SPRVSN_DEPT_NM",  editable:false},
			{title:"보조자",      dataType:"string", dataIndx:"SPRVSN_EMP_NM",   editable:false},
			{title:"대리인",      dataType:"string", dataIndx:"LWYR_NM",         editable:false},
			
			{title:"선임 법무법인 1",   dataType:"string", dataIndx:"RCPT_N_JDAF_CORP_NM1", editable:false},
			{title:"선임 의뢰일 1",     dataType:"string", dataIndx:"RCPT_N_DLGT_YMD1",     editable:false},
			{title:"선임 의뢰 대상 1",  dataType:"string", dataIndx:"RCPT_N_LWYR_NM1",      editable:false},
			{title:"선임 거절 사유 1",  dataType:"string", dataIndx:"RCPT_N_RFSL_RSN1",     editable:false},
			
			{title:"선임 법무법인 2",   dataType:"string", dataIndx:"RCPT_N_JDAF_CORP_NM2", editable:false},
			{title:"선임 의뢰일 2",     dataType:"string", dataIndx:"RCPT_N_DLGT_YMD2",     editable:false},
			{title:"선임 의뢰 대상 2",  dataType:"string", dataIndx:"RCPT_N_LWYR_NM2",      editable:false},
			{title:"선임 거절 사유 2",  dataType:"string", dataIndx:"RCPT_N_RFSL_RSN2",     editable:false}
		];
		...
		var dataModel = {
			...
			url: "${pageContext.request.contextPath}/web/statistics/getSuit12.do",
