...
<script type="text/javascript">
	$(function () {
		...
		var colModel = [
			{title:"담당변호사", dataType:"string", dataIndx:"MNGR_EMP_NM", editable:false},
			...
			{title:"행정",       dataType:"string", dataIndx:"A1",          editable:false},
			{title:"민사",       dataType:"string", dataIndx:"A2",          editable:false},
			{title:"헌법",       dataType:"string", dataIndx:"A3",          editable:false},
			{title:"국가",       dataType:"string", dataIndx:"A4",          editable:false},
			{title:"직무",       dataType:"string", dataIndx:"A5",          editable:false}
		];
		...
		var dataModel = {
			...
			dataType: "json",
			method: "POST",
			url: "${pageContext.request.contextPath}/web/statistics/getSuit13.do",
