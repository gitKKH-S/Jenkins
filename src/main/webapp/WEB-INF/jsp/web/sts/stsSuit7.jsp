...
<script type="text/javascript">
	...
	$(function () {
		...
		var colModel = [
			{title:"문서번호",             dataType:"string", dataIndx:"LWS_NO",          editable:false},
			{title:"사건",                 dataType:"string", dataIndx:"LWS_INCDNT_NM",   editable:false},
			{title:"원고",                 dataType:"string", dataIndx:"WONGO",           editable:false},
			{title:"피고",                 dataType:"string", dataIndx:"PIGO",            editable:false},
			{title:"지정년도(특별착수금)", dataType:"string", dataIndx:"COST_AMT",        editable:false},
			{title:"소송결과",             dataType:"string", dataIndx:"JDGM_UP_TYPE_NM", editable:false}
		];
		...
		var dataModel = {
			...
			url: "${pageContext.request.contextPath}/web/statistics/getSuit7.do",
...
<%
						for(int i=0; i<cdList.size(); i++) {
							...
							if("JDGMTGBN".equals(map.get("CD_LCLSF_ENG_NM").toString())) {
