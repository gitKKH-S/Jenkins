...
<script type="text/javascript">
	...
	$(function () {
		...
		var colModel = [
			{title:"연도",    dataType:"string", dataIndx:"YEAR",           editable:false},
			{title:"사건명",  dataType:"string", dataIndx:"LWS_INCDNT_NM",  editable:false},
			{title:"소가액",  dataType:"string", dataIndx:"LWS_EQVL",       editable:false}
		];
		...
		var dataModel = {
			...
			url: "${pageContext.request.contextPath}/web/statistics/getSuit5.do",
				...
				items:[
					...
					},
					{
						...
						listener: function () {
							...
							saveAs(blob, "진행 중 중요소송 현황."+ format );
						}
				}]
			},
			resizable: false,
