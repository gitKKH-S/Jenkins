...
<script type="text/javascript">
	...
	$(function () {
		...
		var colModel = [
			{title:"연도별",    dataType:"string", dataIndx:"YEARS",  editable:false},
			{title:"계",        dataType:"string", dataIndx:"C0",     editable:false},
			{title:"민간투자",  dataType:"string", dataIndx:"C1",     editable:false},
			{title:"민간위탁",  dataType:"string", dataIndx:"C2",     editable:false},
			{title:"공유재산",  dataType:"string", dataIndx:"C3",     editable:false},
			{title:"임대차",    dataType:"string", dataIndx:"C4",     editable:false},
			{title:"기타",      dataType:"string", dataIndx:"C5",     editable:false},
			{title:"기타계약",  dataType:"string", dataIndx:"C6",     editable:false}
		];
		...
		var dataModel = {
			...
			dataType: "json",
			method: "POST",
			url: "${pageContext.request.contextPath}/web/statistics/stsAgree1.do",
				...
				items:[
					...
					},
					{
						...
						listener: function () {
							...
							saveAs(blob, "계약법률심사 운영실적."+ format );
						}
				}]
			},
			resizable: false,
