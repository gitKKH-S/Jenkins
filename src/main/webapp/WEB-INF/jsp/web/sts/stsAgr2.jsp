...
<script type="text/javascript">
	...
	$(function () {
		...
		var colModel = [
			{title:"연도별",                   dataType:"string", dataIndx:"TARGET_YEAR",  editable:false},
			{title:"사업부서 의뢰 건수",       dataType:"string", dataIndx:"ACNT",         editable:false},
			{title:"사전 시의회 동의 대상",    dataType:"string", dataIndx:"YCNT",         editable:false},
			{title:"사전 시의회 동의 비대상",  dataType:"string", dataIndx:"NCNT",         editable:false}
		];
		...
		var dataModel = {
			...
			dataType: "json",
			method: "POST",
			url: "${pageContext.request.contextPath}/web/statistics/stsAgree2.do",
				...
				items:[
					...
					},
					{
						...
						listener: function () {
							...
							saveAs(blob, "의회동의 여부 검토 현황."+ format );
						}
				}]
			},
			resizable: false,
