...
<script type="text/javascript">
	...
	$(function () {
		...
		var colModel = [
			{title:"구분",   dataType:"string", dataIndx:"TARGET_YEAR",        editable:false},
			{title:"계",     dataType:"string", dataIndx:"TOTAL",              editable:false},
			{title:"이월",   dataType:"string", dataIndx:"CARRIED_OVER_CASES", editable:false},
			{title:"신소",   dataType:"string", dataIndx:"NEW_CASES",          editable:false},
			{title:"계",     dataType:"string", dataIndx:"CLOSED_CASES",       editable:false},
			{title:"승소",   dataType:"string", dataIndx:"WIN_CNT",            editable:false},
			{title:"승소율", dataType:"string", dataIndx:"WIN_RT",             editable:false},
			{title:"패소",   dataType:"string", dataIndx:"LOS_CNT",            editable:false},
			{title:"기타",   dataType:"string", dataIndx:"ETC_CNT",            editable:false},
			{title:"진행",   dataType:"string", dataIndx:"IN_PROGRESS_CASES",  editable:false}
		];
		...
		var dataModel = {
			...
			url: "${pageContext.request.contextPath}/web/statistics/getSuit1.do",
		...
		$("#btnSubmit").click(function() {
			...
			$( "#grid_jsonp" ).pqGrid("option","dataModel.postData", {schType: $("#schType").val(), txtStartDate:$("#txtStartDate").val(), txtEndDate:$("#txtEndDate").val(), searchGbn:searchGbn} );
