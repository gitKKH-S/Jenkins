...
//--> 
	...
	function frame(id){
		if(id=="a"){
			if(document.all.b.style.display == "" && document.all.c.style.display == ""){
			...
			if(document.all.a.style.display == "" && document.all.c.style.display == ""){
					alert("규정,세칙,기준중하나는 화면에 있어야 합니다.");
					return;
				}
			...
			if(document.all.a.style.display == "" && document.all.b.style.display == ""){
				alert("규정,세칙,기준중하나는 화면에 있어야 합니다.");
				return;
			}
	...
	// 본문 Print 
	function print1(Book_id_r,Book_id_c,Book_id_l){
		if(document.all.a.style.display == ""){
			...
			window.open("Dan_print.do?Book_id_l="+Book_id_l+"&Book_id_c="+Book_id_c+"&Book_id_r="+Book_id_r ,"ocase", "width=562,height=420,scrollbars=yes,resizable=no,status=no,toolbar=no");
		}
	}
	// 본문 Print 
...
<BODY topmargin="0" leftmargin="10" onLoad ="next3();next2();next();">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="80" class="printAll"><a href="javascript:print1('<%=Book_id_l %>',document.sel.cen.value,document.sel.rig.value);" >전체인쇄</a></td>
		</tr>
</table>
</div>	
		</td>
...
<div id="pop2ViewBody" style="padding: 0 5px 0 5px; text-align:center;">
	...
	<tr>
		<td valign="top" id="a1" style="display:'';"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
		...
		<td valign="top" id="b1" style="display:'';"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
		...
		<td valign="top" id="c1" style="display:'';"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
