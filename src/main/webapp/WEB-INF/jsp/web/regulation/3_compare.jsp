...
<!--
	function gostr(id,one,tow,tree){
		if(id == 'A'){
			alert("현재기준입니다!!");
			return;	
		}else if(id =='B'){
...
<table width ="100%" style="border-top:2px solid #60AEE0;border-bottom:1px solid #60AEE0;" bgcolor="#D2E4FA">
	<tr>
		<th width="33%" align="center" onMouseOver="this.style.backgroundColor='FFFFFF'" onmouseout="this.style.backgroundColor=''" onclick="gostr('A','<%=Book_id_l %>','<%=Book_id_c %>','<%=Book_id_r %>');">
		...
		<th width="33%" align="center" onMouseOver="this.style.backgroundColor='FFFFFF'" onmouseout="this.style.backgroundColor=''" onclick="gostr('B','<%=Book_id_l %>','<%=Book_id_c %>','<%=Book_id_r %>');">
		...
		<th width="33%" align="center" onMouseOver="this.style.backgroundColor='FFFFFF'" onmouseout="this.style.backgroundColor=''" onclick="gostr('C','<%=Book_id_l %>','<%=Book_id_c %>','<%=Book_id_r %>');">
...
out.println("<table border=\"0\" width=\"100%\">");
	...
	%>
	<tr>
		<th width="33%" align="center" onMouseOver="this.style.backgroundColor='e0ffff'" onmouseout="this.style.backgroundColor=''" onclick="gostr('A','<%=Book_id_l %>','<%=Book_id_c %>','<%=Book_id_r %>');">
			<span title='' class="aaa"  style="cursor:hand;">
				<nobr style="text-overflow:ellipsis;overflow:hidden;width=300PX"></nobr>
			</span>
		</th>
		<th width="33%" align="center" onMouseOver="this.style.backgroundColor='e0ffff'" onmouseout="this.style.backgroundColor=''" onclick="gostr('B','<%=Book_id_l %>','<%=Book_id_c %>','<%=Book_id_r %>');">
			<span title='' class="aaa"  style="cursor:hand;">
				<nobr style="text-overflow:ellipsis;overflow:hidden;width=300PX"></nobr>
			</span>
		</th>
		<th width="33%" align="center" onMouseOver="this.style.backgroundColor='e0ffff'" onmouseout="this.style.backgroundColor=''" onclick="gostr('C','<%=Book_id_l %>','<%=Book_id_c %>','<%=Book_id_r %>');">
			<span title='' class="aaa"  style="cursor:hand;">
				<nobr style="text-overflow:ellipsis;overflow:hidden;width=300PX"></nobr>
			</span>
		</th>
