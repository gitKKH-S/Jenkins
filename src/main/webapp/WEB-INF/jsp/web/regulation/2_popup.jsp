...
//--> 
	...
	function frame(id){
		if(id=="a"){
			if(document.all.b.style.display == ""){
				alert("규정,세칙중하나는 화면에 있어야 합니다.");
				return;
			}
	...
	// 본문 Print 
	function print1(Book_id_c,Book_id_l){
		window.open("Dan_print.do?Book_id_l="+Book_id_l+"&Book_id_c="+Book_id_c ,"ocase", "width=562,height=420,scrollbars=yes,resizable=no,status=no,toolbar=no");
	}
	// 본문 Print 
...
<BODY topmargin="0" leftmargin="10" onLoad ="next2();next();">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="80" class="printAll"><a href="javascript:print1('<%=Book_id_l %>',document.sel.cen.value);" >전체인쇄</a></td>
		</tr>
</table>
</div>	
		</td>
...
<div id="pop2ViewBody" style="padding: 0 5px 0 5px; text-align:center;">
	...
	<tr>
		...
		<td valign="top" id="b1" style="display:'';"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td><iframe id="b2" name="b12" src="" scrolling="yes" frameborder="0" width="100%" height="100%" marginheight="10" marginwidth="10">
							</iframe></td>
			</tr>
		</table></td>
	</tr>
