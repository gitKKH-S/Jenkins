...
$(document).ready(function(){
	...
	$("#totalview").click(function(){
		location.href = "regulationView.do?bookid=<%=meta.get("BOOKID")%>&noformyn=<%=meta.get("NOFORMYN")%>&vtype=TOTAL";
	});
	...
	$("#nowbook").click(function(){
		location.href = "regulationView.do?bookid=<%=nowbookid%>&noformyn=<%=nownoformyn%>";
	});
    ...
    <input type="hidden" name="TITLE" id="TITLE" value="<%=meta.get("TITLE")%>">
		...
		<div class="funGroup">
			...
			<div class="funRight">
				...
				<a href="#" class="funBtn" id="newWin"><i class="fa fa-window-maximize" aria-hidden="true"></i> 새창</a>
