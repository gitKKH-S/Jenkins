...
<%
	String agreeid = request.getAttribute("agreeid")==null?"":(String)request.getAttribute("agreeid");
...
<script type="text/javascript">
			...
			listeners: {
				click: function(node, e){
					...
					//if(node.id != "39400000000"){
						...
						getUserList(node.id, $("#srchTxt2").val());
					//}
				}
				/* ,
	...
	function setSelInfo(id, name, gbn){
		...
		$.ajax({
			type:"POST",
			url:"${pageContext.request.contextPath}/web/agree/chgUserSetting.do",
