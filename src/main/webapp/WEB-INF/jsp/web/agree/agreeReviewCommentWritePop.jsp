...
<script type="text/javascript">
	...
	function saveProgInfo(sfilenm, vfilenm){
		...
		if(confirm("내용을 저장하시겠습니까?")){
			...
			$.ajax({
				type:"POST",
				url : "${pageContext.request.contextPath}/web/agree/saveReviewComment.do",
...
<!-- 				</tr> -->
				<tr>
					<th>검토 의견</th>
					<td>
						<textarea id=CVTN_ANS_RVW_OPNN_CN name="CVTN_ANS_RVW_OPNN_CN" rows="10" cols=""><%=reviewComment.get("CVTN_ANS_RVW_OPNN_CN")==null?"":reviewComment.get("CVTN_ANS_RVW_OPNN_CN").toString()%></textarea>
					</td>
				</tr>
				<tr>
					<th>
