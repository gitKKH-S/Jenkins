...
<%
	...
	int danchk = bonInfo.get("DANCHK")==null?0:Integer.parseInt(bonInfo.get("DANCHK").toString());
%>
...
$(document).ready(function(){
	...
	$("#newWin").click(function(){
		...
		var newWindow = window.open("lawViewPagePop.do?LAWID=<%=param.get("LAWID")%>","",property);
	});
