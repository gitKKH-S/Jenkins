...
<script type="text/javascript">
	...
	Ext.onReady(function(){
		...
		var cmm = new xg.ColumnModel({
				columns:[
						...
						{header:"<b>조약명</b>",  style: 'text-align:center', dataIndex:'title', sortable: true},
						{header:"<b>조약번호</b>",  width:30, align:'center', dataIndex:'jno', sortable: true},
						{header:"<b>구분</b>",  width:40, align:'center', dataIndex:'gbn'},
						{header:"<b>발효일자</b>",  width:40, align:'center', dataIndex:'ndt', sortable: true},
						{header:"<b>서명일자</b>",  width:40, align:'center', dataIndex:'sdt', sortable: true}
					]
				});
	...
	function goView2(url){
		...
		//새창의 크기
		 ...
		 py=(sh-ch)/2;
		 //창을 여는부분
		property="left="+px+",top="+py+",width=1300,height=600,scrollbars=yes,resizable=yes,status=no,toolbar=no";
		var pop_f;
