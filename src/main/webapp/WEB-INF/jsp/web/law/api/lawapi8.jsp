	...
	Ext.onReady(function(){
		...
		var cmm = new xg.ColumnModel({
				columns:[
						...
						{header:"<b>사건번호</b>",  width:30, align:'center', dataIndex:'caseno', sortable: true},
						{header:"<b>처분일자</b>",  width:40, align:'center', dataIndex:'fdt'},
						{header:"<b>의결일자</b>",  width:40, align:'center', dataIndex:'adt', sortable: true},
						{header:"<b>처분청</b>",  width:40, align:'center', dataIndex:'fdept'},
						{header:"<b>재결청</b>",  width:40, align:'center', dataIndex:'rdept'},
