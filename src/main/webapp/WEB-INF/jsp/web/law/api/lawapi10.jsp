	...
	Ext.onReady(function(){
		...
		var cmm = new xg.ColumnModel({
				columns:[
						...
						{header:"<b>별표</b>",  style: 'text-align:center', dataIndex:'byult', sortable: true},
						{header:"<b>관련법령</b>",  width:30, align:'center', dataIndex:'lawt'},
						{header:"<b>첨부파일</b>",  width:40, align:'center', dataIndex:'filen',
							editor: {
						        xtype: 'checkbox',
						        inputValue: 'Y'
						    },
						    renderer: function(value,cell,record,rowindex,columnindex,store) {
						    	var rowData = dsCode.getAt(rowindex);
								var filen = rowData.get('filen');
								var ret = "<a href='http://www.law.go.kr"+filen+"'>다운로드</a>";
								return ret;
						    }
						},
						{header:"<b>별표종류</b>",  width:40, align:'center', dataIndex:'byulcd'},
						{header:"<b>소관부처</b>",  width:40, align:'center', dataIndex:'dept'},
						{header:"<b>공포번호</b>",  width:40, align:'center', dataIndex:'promulno'},
						{header:"<b>공포일</b>",  width:40, align:'center', dataIndex:'promuldt'},
