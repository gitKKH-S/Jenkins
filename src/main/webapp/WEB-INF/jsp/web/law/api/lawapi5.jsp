	...
	Ext.onReady(function(){
		...
		var cmm = new xg.ColumnModel({
				columns:[
						...
						{header:"<b>안건명</b>",  style: 'text-align:center', dataIndex:'title', sortable: true},
						{header:"<b>안건번호</b>",  width:30, align:'center', dataIndex:'anno', sortable: true},
						{header:"<b>질의기관명</b>",  width:40, align:'center', dataIndex:'qdept'},
						{header:"<b>회신기관명</b>",  width:40, align:'center', dataIndex:'rdept'},
						{header:"<b>분야명</b>",  width:40, align:'center', dataIndex:'lawcd'},
						{header:"<b>회신일자</b>",  width:40, align:'center', dataIndex:'rdt', sortable: true}
					]
				});
