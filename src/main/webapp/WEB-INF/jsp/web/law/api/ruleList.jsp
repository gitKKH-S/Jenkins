	...
	Ext.onReady(function(){
		...
		var cmm = new xg.ColumnModel({
				columns:[
						...
						{header:"<b>자치법규명</b>",  style: 'text-align:center', dataIndex:'title', sortable: true},
						...
						{header:"<b>법규종류</b>",  width:40, align:'center', dataIndex:'lawcd'},
						{header:"<b>지자체기관</b>",  width:40, align:'center', dataIndex:'dept'},
						{header:"<b>자치법규분야</b>",  width:40, align:'center', dataIndex:'bookcd'}
					]
				});
