	...
	Ext.onReady(function(){
		...
		gridStore = new Ext.data.Store({
			proxy:new Ext.data.HttpProxy({
				url:"${pageContext.request.contextPath}/web/law/favListData.do"
			}),
			remoteSort:true,
		...
		$("#mkexcel").click(function(){
            ...
            var url = "${pageContext.request.contextPath}/web/law/favListDataMakeExcel.do";
...
<div class="subCA">
	...
	<div class="innerB">
		...
		<div class="boardSrchW">
			<div class="bS_left">
				...
				<!-- <input type="checkbox" id="scontent" checked="checked"> <label>법률내용</label>
	...
	<div class="subBtnW side">
		...
		<div class="subBtnC right">
			...
			<a href="#none" id="favBtn" class="sBtn type2">즐겨찾기 삭제</a>
		</div>
	</div>
	<div class="innerB">
		<div id="gridList"></div>
