...
<%-- 	<input type="hidden" name="${_csrf.parameterName}"   value="${_csrf.token}"/> --%>
	...
	<input type="hidden" name="filegbn"   id="filegbn"   value="CCOST">
	...
	<input type="hidden" id="RESMNGNO" name="RESMNGNO">
			...
			<table class="pop_infoTable write" style="height:100%;">
				...
				%>
						<select id="setlawyer" style="border:1px solid;"">
							<option value="">비용 정보를 등록 할 자문위원을 선택하세요</option>
				<%
