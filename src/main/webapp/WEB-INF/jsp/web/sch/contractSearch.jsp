...
<input type="hidden" id="hidden_indexKey" value="<%=param_index %>" />
<input type="hidden" id="hidden_pageNum" value="1" />
<input type="hidden" id="hidden_listNum" value="10" />

<script type="text/javascript" src="${resourceUrl}/search/js/contractSearch.js"></script>
<script type="text/javascript" src="${resourceUrl}/search/js/param.js"></script>
<div class="subCA">
	<div class="subTabW set7">
		<hr class="margin30">
		<ul>
			<%-- <li><a href="${pageContext.request.contextPath}/web/search.do">전체</a></li>
			<li><a href="${pageContext.request.contextPath}/web/suitSearch.do">소송·심판</a></li>
			<li><a href="${pageContext.request.contextPath}/web/consultSearch.do">자문</a></li>
			<li><a href="${pageContext.request.contextPath}/web/agreeSearch.do">협약</a></li>
			<li><a href="${pageContext.request.contextPath}/web/regulationSearch.do">자치법규</a></li>
			<li><a href="${pageContext.request.contextPath}/web/pdsSearch.do">자료실</a></li>
			<li><a href="${pageContext.request.contextPath}/web/contractSearch.do" class="active">게시판</a></li> --%>
			...
			<li><a href="javascript:sendPost('./regulationSearch.do')">자치법규</a></li>
			...
			<li><a href="javascript:sendPost('./contractSearch.do')" class="active">게시판</a></li>
		</ul>
	</div>
	<div class="innerB">
		<table class="infoTable write">
			...
			<tr>
				<th>검색 조건</th>
				<td colspan="4">
					<input type="radio" name="schGbn" value="META" id="schGbn_0" checked/> 기본정보검색(제목+내용+작성자)　　　　
					<input type="radio" value="FILE" name="schGbn" id="schGbn_1"/> 첨부파일검색
					</td>
				<th>정렬</th>
				<td>
			...
			<tr>
				<th>검색어</th>
				<td colspan="6"><input type="text" style="width:90%;" id="txtSearchBar">&nbsp;&nbsp;
					<input type="checkbox" name="reSearch" value="" id="reSearch"> 결과내 검색</td>
			</tr>
		</table>
	</div>
	...
	<strong class="subTT">게시판</strong>
	<div class="innerB" id="pds_data_list"></div>
	<div class="innerB">
