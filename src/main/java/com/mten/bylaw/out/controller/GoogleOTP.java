...
public class GoogleOTP {
	...
	public static void main(String[] args) {
		...
		HashMap<String, String> map = otp.generate("kyugwan", "test.seoul.co.kr");
		...
		boolean check = otp.checkCode("246265", otpkey);
	...
	public static String getQRBarcodeURL(String user, String host, String secret) {
		...
		String format2 = "https://api.qrserver.com/v1/create-qr-code/?size=177x177&data=otpauth://totp/%s@%s%%3Fsecret%%3D%s&chld=H|0";
