...
public class GoogleOtpController {
	...
	public String second(HttpServletRequest request, Locale locale, Model model) throws ServletRequestBindingException {
		...
		if(id.equals(test_id) && pw.equals(test_pw))
		{
			...
			String url = getQRBarcodeURL("test", "yourdomain.com", secretKeyStr); // 생성된 바코드 주소!
...
//      byte[] secretKey = Arrays.copyOf(buffer, secretSize);
	...
	public static String getQRBarcodeURL(String user, String host, String secret) {
        ...
        String format = "https://api.qrserver.com/v1/create-qr-code/?size=70x70&data=chl=otpauth://totp/%s@%s%%3Fsecret%%3D%s&amp;chld=H|0";
