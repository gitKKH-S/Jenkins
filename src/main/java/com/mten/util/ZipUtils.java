...
public class ZipUtils {
    public static void main(String args[]){
        File a1 = new File("E:/mtendev/newp/wtl/src/main/webapp/dataFile/attach/100240904/");
        File a2 = new File("E:/mtendev/newp/wtl/src/main/webapp/dataFile/attach/100240904.zip");
        try {
            decompress(a1,a2);
        } catch (Exception e) {
            e.printStackTrace();
